...
android {
    ...
    compileOptions {
        ...
        // ✅ Requis par flutter_local_notifications (java.time API)
    ...
    buildTypes {
        release {
            // ✅ Utiliser la config de signature release
...
dependencies {
    // ✅ Requis pour coreLibraryDesugaring (flutter_local_notifications)
